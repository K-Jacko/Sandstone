...
public class MeshData
{
    ...
    public MeshData(int verticesPerLine)
    {
        ...
        borderVertecies = new Vector3[verticesPerLine * 4 + 4];
    ...
    {
        Vector3 pointA = (indexA < 0) ? borderVertecies[-indexA - 1] : verticies[indexA];
        Vector3 pointB = (indexB < 0) ? borderVertecies[-indexB- 1] : verticies[indexB];
        Vector3 pointC = (indexC < 0) ? borderVertecies[-indexC - 1] : verticies[indexC];
